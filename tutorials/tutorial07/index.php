...
<a href="logout.php"><button type="button" class="btn btn-success" id="button" valign="right">Log out</button></a>
<button type="btn" class="btn btn-success" id="button" valign="right">Add New Data</button>
